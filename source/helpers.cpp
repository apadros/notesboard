...
program_external bool MouseIsWithinCanvasSpace(win32_state& osState) {
	return osState.mousePos.x > GetTopRight(GetToolBar()->background).x && osState.mousePos.y < GetTitleBar()->container.bottom;
}
